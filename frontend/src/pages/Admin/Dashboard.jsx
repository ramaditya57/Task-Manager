...
const Dashboard = () => {
  ...
  return <DashboardLayout activeMenu="Dashboard">
      <div className='bg-[#1F2937] border border-gray-700 text-white rounded-xl p-6 my-5 shadow-md'>
        <div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6 my-4 md:my-6'>
        ...
        <div>
          <div className='bg-[#1F2937] border border-gray-700 text-white rounded-xl p-6 shadow-md'>
        ...
        <div className='md:col-span-2'>
          <div className='bg-[#1F2937] border border-gray-700 text-white rounded-xl p-6 shadow-md'>
            <div className='flex items-center justify-between'>
              ...
              <button className='text-indigo-400 hover:text-indigo-300 flex items-center gap-1' onClick={onSeeMore}>
