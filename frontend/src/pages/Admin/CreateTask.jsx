...
const CreateTask = () => {
  ...
  const createTask = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.post(API_PATHS.TASKS.CREATE_TASK,{ ...taskData, dueDate: new Date(taskData.dueDate).toISOString(), todoChecklist: todoChecklist,});
  ...
  const updateTask = async() => {
    ...
    try {
      ...
      const response = await axiosInstance.put(API_PATHS.TASKS.UPDATE_TASK(taskId),{ ...taskData, dueDate: new Date(taskData.dueDate).toISOString(), todoChecklist: todoChecklist,});
  ...
  const deleteTask = async () => {
    try{
      ...
      console.error('Error while deleting: ',error.response?.data?.message || error.message);
    }
  };
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 mt-4'>
          <div className='form-card col-span-3'>
            ...
            <div className='mt-3'>
              ...
              <textarea className='form-input' placeholder='Describe task' rows={4} value={taskData.description} onChange={({target}) => handleValueChange('description', target.value)} />
            </div>
            ...
            <div className='grid grid-cols-12 gap-4 mt-2'>
              ...
              <div className="col-span-6 md:col-span-4">
                ...
                <input type="date" placeholder='Create App UI' value={taskData.dueDate || ''} onChange={({target}) => handleValueChange('dueDate', target.value)} className="form-input" />
              </div>
            ...
            <div className="mt-3">
              ...
              <TodoListInput todoChecklist={taskData?.todoChecklist} setTodoChecklist={(value) => handleValueChange('todoChecklist', value)} />
            </div>
