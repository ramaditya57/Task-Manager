...
const TaskCard = ({
  ...
  const getStatusTagColor = () => {
    switch (status) {
      case 'In Progress':
        return 'text-cyan-500 bg-cyan-50 dark:bg-cyan-500/10 border border-cyan-500/50';
      case 'Completed':
        return 'text-lime-500 bg-lime-50 dark:bg-lime-500/10 border border-lime-500/20';
      default:
        return 'text-violet-500 bg-violet-50 dark:bg-violet-500/10 border border-violet-500/10';
    }
  };
  ...
  const getPriorityTagColor = () => {
    switch (priority) {
      case 'Low':
        return 'text-emerald-500 bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-500/10';
      case 'Medium':
        return 'text-amber-500 bg-amber-50 dark:bg-amber-500/10 border border-amber-500/10';
      default:
        return 'text-rose-500 bg-rose-50 dark:bg-rose-500/10 border border-rose-500/10';
    }
  };
    ...
    >
      ...
      <div className="px-4">
        ...
        <div className="flex items-center justify-between mt-3">
          ...
          {attachmentCount > 0 && (
            <div className="flex items-center gap-2 bg-blue-50 dark:bg-blue-500/10 px-2.5 py-1.5 rounded-lg">
